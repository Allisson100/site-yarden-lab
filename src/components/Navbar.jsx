  ...
  return (
    <>
      ...
      >
        ...
        {/* Desktop */}
        <div className="desktop-nav" style={{ display: 'flex', alignItems: 'center', gap: '44px' }}>
          {links.map(link => (
            <a
              key={link.href}
              href={link.href}
          ...
          <a
            href={`https://wa.me/5511953107865?text=${encodeURIComponent('Olá! Vim pelo site da Yarden Lab e gostaria de conversar.')}`}
            target="_blank"
