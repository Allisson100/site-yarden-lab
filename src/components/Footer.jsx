    ...
    <footer style={{ background: 'var(--espresso)', borderTop: '1px solid rgba(243,235,226,0.06)' }}>
      ...
      <div className="container footer-inner" style={{ padding: '80px 60px 60px' }}>
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              Laboratório de marca que une estratégia criativa, tecnologia e inteligência artificial
              para construir presença real no mercado premium.
            </p>
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
              {[
                ...
                >
                  {icon}
                  <span>{handle}</span>
                  <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ opacity: 0.4 }}>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {navLinks.map(link => (
                <li key={link.href}>
                  ...
                  onMouseLeave={e => e.currentTarget.style.color = 'rgba(243,235,226,0.45)'}>
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <a href="mailto:contato@yardenlab.com.br" style={{
                color: 'rgba(243,235,226,0.45)',
                fontSize: '13px',
                fontWeight: 300,
                transition: 'color 0.2s',
              ...
              <p style={{ color: 'rgba(243,235,226,0.35)', fontSize: '13px', fontWeight: 300, lineHeight: 1.5 }}>
                São Paulo, Brasil
              </p>
            </div>

            <div style={{ marginTop: '32px' }}>
              <a href="#contact" className="btn-outline-light" style={{ fontSize: '11px', padding: '12px 20px' }}>
                Fale Conosco
              </a>
            </div>
          </div>
        ...
        <div style={{
          ...
          <p style={{ color: 'rgba(243,235,226,0.25)', fontSize: '12px', fontWeight: 300 }}>
            © {new Date().getFullYear()} Yarden Lab®. Todos os direitos reservados.
          </p>
          <p style={{
