...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!FORMSPREE_ID) {
      ...
      window.open(
        `mailto:contato@yardenlab.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`,
      );
      setSent(true);
      setLoading(false);
      return;
        ...
        >
          ...
          >
            ...
            >
              ...
              estética — a Yarden Lab é o parceiro certo. Conte-nos sobre o seu
              momento e vamos juntos encontrar o caminho ideal.
            </p>
                ...
                <motion.form key="form" onSubmit={handleSubmit}>
                  ...
                  >
                    <input
                      ...
                      style={inputStyle}
                      onFocus={(e) =>
                        (e.target.style.borderColor = "rgba(243,235,226,0.4)")
                      }
                      onBlur={(e) =>
                        (e.target.style.borderColor = "rgba(243,235,226,0.14)")
                      }
                    />
                    <input
                      name="company"
                  ...
                  >
                    <option value="" style={{ background: "#1c0608" }}>
                      Produto de interesse
                    </option>
                    <option
                      value="diagnostico"
                      style={{ background: "#1c0608" }}
                    >
                      Diagnóstico Yarden
                    </option>
                    <option value="travessia" style={{ background: "#1c0608" }}>
                      Plano Travessia
                    </option>
                    <option
                      value="corrente-light"
                      style={{ background: "#1c0608" }}
                    >
                      Operação Corrente Light
                    </option>
                    <option
                      value="corrente-standard"
                      style={{ background: "#1c0608" }}
                    >
                      Operação Corrente Standard
                    </option>
                    <option value="360" style={{ background: "#1c0608" }}>
                      Operação Yarden 360
                    </option>
                    <option
                      value="inteligencia"
                    ...
                    <option value="captacao" style={{ background: "#1c0608" }}>
                      Sprint de Captação
                    </option>
                    <option value="outro" style={{ background: "#1c0608" }}>
